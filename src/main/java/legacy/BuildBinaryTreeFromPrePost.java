...
public class BuildBinaryTreeFromPrePost {
    public static class TreeNode {
        int val;
        BuildBinaryTreeFromMidPost.TreeNode left;
        BuildBinaryTreeFromMidPost.TreeNode right;
        ...
        TreeNode(int val, BuildBinaryTreeFromMidPost.TreeNode left, BuildBinaryTreeFromMidPost.TreeNode right) {
            this.val = val;
            this.left = left;
            this.right = right;
        }
...
//    static int[] postorder = new int[]{-1};
    ...
    public static void main(String[] args) {
        int rootIndex = 0;
        BuildBinaryTreeFromMidPost.TreeNode root = new BuildBinaryTreeFromMidPost.TreeNode(postorder[postCursor]);
    ...
    public static BuildBinaryTreeFromMidPost.TreeNode traverseSubTree(int[] inorder, int start, int end) {
        BuildBinaryTreeFromMidPost.TreeNode subRoot = new BuildBinaryTreeFromMidPost.TreeNode(postorder[postCursor]);
        int rootIndex = start;
